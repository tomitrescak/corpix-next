...
// import { EditorComponent, FormComponentProps, safeEval } from '@toryjs/form';
// import {
//   prop,
//   propGroup,
//   handlerProp,
...
//     let data: any;
//     try {
//       data = safeEval(null, `(${fakeData.trim()})`);
//     } catch (ex) {
...
//   title: 'Fetch API',
//   control: 'Fetch',
//   icon: createIcon('download', 'Fetch'),
//   provider: true,
//   group: 'Web',
//   props: {
//     ...propGroup('Fetch', {
